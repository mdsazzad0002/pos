<footer>
    <div class="container-fluid">
        ...
        <div class="footer-wrapper pt-40 mb-32">
            ...
            <div class="footer_maps_block" style="width: 40vw; padding-right: 30px;">
                <div class="footer-map">
                    <iframe src="{{ settings('app_maps', 9) }}" width="100%" style="min-height: 192px;" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>

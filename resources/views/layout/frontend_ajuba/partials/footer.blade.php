    ...
    <div class="container-fluid">
                ...
                <div class="col-xxl-10 col-xl-12">
                    <div class="row row-gap-3">
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-1-sm.png" alt="">
                                </div>
                        ...
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-2-sm.png" alt="">
                                </div>
                                <div class="content-box">
                        ...
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-3-sm.png" alt="">
                                </div>
                                <div class="content-box">
                        ...
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-4-sm.png" alt="">
                                </div>
                                <div class="content-box">
                        ...
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-5-sm.png" alt="">
                                </div>
                                <div class="content-box">
                        ...
                        <div class="col-xl-2 col-md-4 col-6">
                            <div class="benefit-block">
                                <div class="image-box mb-12">
                                    <img src="{{asset('uploads/')}}/icons/icon-6-sm.png" alt="">
                                </div>
                                <div class="content-box">
        ...
        <div class="footer-wrapper pt-40 mb-32">
            <div class="store-desc">
                <a href="index.html"><img src="{{asset('uploads/')}}/logo.png" alt="" class="mb-16"></a>

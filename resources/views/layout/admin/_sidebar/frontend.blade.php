@canany(['slider read', 'service read', 'offerbanner read', 'testimonial read', 'faq read'])
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.project.index') }}"
                        class="nav-link {{ Route::is('admin.project.edit') || Route::is('admin.project.create') ? 'active' : '' }}">
                        ...
                        @can('blog read')
                            <li class="nav-item">
                                <a href="{{ route('admin.blog.blog.index') }}"
                                    class="nav-link {{ Route::is('admin.blog.blog.edit') ? 'active' : '' }}">
                                    <i class="fas fa-user-tie nav-icon"></i>
                                    <p>Blog</p>
                                </a>
                            </li>
    ...
    <li class="nav-item">
        <a href="{{ route('admin.product-style.index') }}"
            class="nav-link {{ Request::routeIs('admin.product-style.*') ? 'active' : '' }}">
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ route('admin.whychooseus.index') }}"
                    class="nav-link {{ Request::routeIs('admin.whychooseus.*') ? 'active' : '' }}">
                    <i class="fas fa-check-circle nav-icon"></i>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.achivement.index') }}"
                    class="nav-link {{ Request::routeIs('admin.achivement.*') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.page.index') }}"
                        class="nav-link {{ Request::routeIs('admin.homePageManage.*') ? 'active' : '' }}" class="nav-link">
                        <i class="fas fa-book nav-icon"></i>
                        <p>Page </p>
                    </a>
                </li>

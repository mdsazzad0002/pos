...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div>
            ...
            <button class="btn btn-primary" onclick="button_ajax(this)" data-dialog=" modal-dialog-scrollable modal-dialog-centered" data-title="Add New  Client" data-href="{{ route('admin.client.create') }}">+ Add New Client</button>
            @endcan
        </div>
    </div>
    <div class="card-body">

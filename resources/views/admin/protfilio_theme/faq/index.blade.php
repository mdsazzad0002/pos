...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div>
            @can('faq create')
                <button class="btn btn-primary" onclick="button_ajax(this)" data-dialog=" modal-dialog-scrollable modal-dialog-centered" data-title="Add New  faq" data-href="{{ route('admin.faq.create') }}">+ Add New faq</button>
            @endcan
        </div>
    </div>
    <div class="card-body">
        <table id="faq" class="table table-bordered table-striped table-hover">
            <thead>
                <th>
                    SI
                </th>

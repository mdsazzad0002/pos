...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div>
            @can('page create')
                <button class="btn btn-primary" onclick="button_ajax(this)" data-dialog=" modal-dialog-scrollable modal-dialog-centered" data-title="Add New  page" data-href="{{ route('admin.page.create') }}">+ Add New page</button>
            @endcan
        </div>
    </div>
    <div class="card-body">

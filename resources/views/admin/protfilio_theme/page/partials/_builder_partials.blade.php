<button class='btn btn-danger rounded rounded-circle ml-auto'  data-title='{{ $item->title }}'
                        onclick='button_ajax(this)'
                        data-href='{{ route('admin.homePageManage.delete', $item->id) }}'><i class="fa fa-trash" aria-hidden="true"></i></button>
        ...
        <div class="card-body">
            ...
            <form class="form_ajax_submit" action="{{ route('admin.homePageManage.update',  $item->id ) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <label for="background_type"> Page Status <br />
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="background" name="background" value="{{ $item->background }}" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">

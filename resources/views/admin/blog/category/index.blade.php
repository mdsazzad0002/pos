...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div>
            @can('user create')
                <button class="btn btn-primary" onclick="button_ajax(this)" data-dialog=" modal-dialog-scrollable modal-dialog-centered" data-title="Add New  Category" data-href="{{ route('admin.blog.category.create') }}">+ Add New Category</button>
            @endcan
            @can('user read')
                <a class="btn btn-primary" href="{{route('admin.blog.category.category_for_order')}}"> <i class="fa fa-th-large" aria-hidden="true"></i>
                    Manage Order</a>
            @endcan
        </div>
    </div>

...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        Achivement
        <div>
            @can('achivement create')
                <button class="btn btn-primary" onclick="button_ajax(this)" data-dialog=" modal-dialog-scrollable modal-dialog-centered" data-title="Add New  Why Choose Us" data-href="{{ route('admin.achivement.create') }}">+ Add New Achivement</button>
            @endcan

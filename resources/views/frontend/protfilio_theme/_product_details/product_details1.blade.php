                                ...
                                <div class="product-text-container bg-white br-20">
                                    ...
                                    <div class="d-flex align-items-center gap-16 mb-24">
                                        ...
                                        <ul class="list-unstyled social-link m-0">
                                            ...
                                            <li>
                                                <a
                                                    href="https://twitter.com/intent/tweet?text={{ $products->name }}&url={{ url()->full() }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" viewBox="0 0 16 16" fill="none">
                                            ...
                                            <li>
                                                <a
                                                    href="https://www.linkedin.com/shareArticle?mini=true&url={{ url()->full() }}&title={{ $products->name }}&summary={{ $products->description }}&source={{ url()->full() }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" viewBox="0 0 16 16" fill="none">

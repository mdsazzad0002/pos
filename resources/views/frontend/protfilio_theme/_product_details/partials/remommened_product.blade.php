    ...
    <section class="recommended-product bg-lightest-gray pb-40">
        <div class="container-fluid">
            <div class="top-bar mb-16">
                ...
                <a href="{{ url($filter_page->slug) }}?category={{ $products->categorys->slug ?? '' }}" class="cus-btn-arrow"> Show All
            ...
            <div class="row row-gap-4">
                ...
                @php
                    $samilar_product = \App\Models\product::where('category', $products->category)->limit(20)->paginate(20);
                @endphp

                @include('frontend.protfilio_theme._product_default.partials.filter_product', ['product_list'=> $samilar_product]);

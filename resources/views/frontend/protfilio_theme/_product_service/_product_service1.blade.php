@php
    ...
    if ($variant_info->is_details_page) {
        $products = \App\Models\Product::where('status', 1)->where('service', 1)->paginate($variant_info->items_show);
    } else {
    ...
    <div class="product_wise_cateogry-product-sec pb-4">
        <div class="container-fluid">
            ...
            <div class="row row-gap-3">
                @include('frontend.protfilio_theme._filter_variant.partials.product_items', [
                    'product' => $products,
                ])

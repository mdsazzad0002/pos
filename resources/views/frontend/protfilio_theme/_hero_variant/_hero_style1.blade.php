...
<link rel="stylesheet" href="{{ asset('frontend/protfilio_theme/css/_hero_style/_hero_style1.css') }}">
<!-- Hero Section -->
<section id="hero_hero_style1" class="hero_hero_style1 section dark-background">

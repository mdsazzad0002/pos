        ...
        <div class="container-fluid">
            <div class="d-lg-block d-none">
                ...
                <table class="cart-table">
                    <tbody>
                        @php
                            $products =  \App\Models\product::whereIn('id',session('compare_list',[]));
                        @endphp
                        ...
                        <tr class="table-row wishlist-row">
                            <td class="pd">
                                <div class="product-detail-box">
                                    ...
                                    <div class="img-block">
                                        <a href="shop-grid-2.html"><img src="assets/media/images/cart-image-1.png"
                                                alt=""></a>
                                    </div>
                        ...
                        <tr class="table-row wishlist-row">
                            <td class="pd">
                                <div class="product-detail-box">
                                    ...
                                    <a href="" class="h5 dark-black"><i class="fal fa-times"></i></a>
                                    <div class="img-block">
                                        <a href="shop-grid-2.html"><img src="assets/media/images/cart-image-2.png"
                                                alt=""></a>
                                    </div>
                                    <div class="d-block text-start">
            ...
            <div class="d-lg-none d-block">
                <div class="row">
                    <div class="col-md-6">
                        <div class="cart-item-block mb-32">
                            <div class="img-block mb-16">
                                <a href="product-detail-1.html"><img src="assets/media/images/cart-image-1.png"
                                        alt=""></a>
                    ...
                    <div class="col-md-6">
                        <div class="cart-item-block mb-32">
                            <div class="img-block mb-16">
                                <a href="product-detail-1.html"><img src="assets/media/images/cart-image-2.png"
                                        alt=""></a>
                                <a href="" class="cross"><i class="fal fa-times"></i></a>
                            </div>

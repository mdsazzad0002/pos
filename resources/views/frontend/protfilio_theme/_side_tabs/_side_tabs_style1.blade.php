<!-- Tabs Section -->
<link rel="stylesheet" href="{{ asset('frontend/protfilio_theme/css/_side_tabs/_side_tabs1.css') }}">
<section id="side_side_tabs1" class="side_side_tabs1 section">
      ...
      <div class="col-lg-6">
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="tab-pane fade active show" id="tabs-tab-1">
            <img src="{{ asset('uploads/portfolio')}}/tabs-1.jpg" alt="" class="img-fluid">
          </div><!-- End Tab Content Item -->

          <div class="tab-pane fade" id="tabs-tab-2">
            <img src="{{ asset('uploads/portfolio')}}/tabs-2.jpg" alt="" class="img-fluid">
          </div><!-- End Tab Content Item -->

          <div class="tab-pane fade" id="tabs-tab-3">
            <img src="{{ asset('uploads/portfolio')}}/tabs-3.jpg" alt="" class="img-fluid">
          </div><!-- End Tab Content Item -->
        </div>

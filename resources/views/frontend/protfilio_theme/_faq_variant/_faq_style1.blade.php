...
<x-frontend_section :info="$variant_info" class="faq_faq_style1" css="_faq_style/_faq_style1.css">
    ...
    <div class="container">
            ...
            <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
                <div class="faq-container row">
                    @forelse($faq_list as $key => $faq)
                        <div
                            class="col-lg-{{ 12 / ($variant_info->items_per_row != 0 ? $variant_info->items_per_row : 1) }} mb-2">
        ...
        @if ($variant_info->view_all_status)
            <div class="text-center">
                <a href="{{ route('faq.index') }}" class="btn_primary">{{ $variant_info->short_read_more }} <i

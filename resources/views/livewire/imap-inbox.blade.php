<div>
    <div style="min-height: 60px">
        ...
        <div x-data="{ errorMessage: '', showError: false, connectionError: false }"
            ...
            <div class="p-3 mb-2 bg-secondary rounded" x-show="connectionError" style="display: none">
                Try to Check Connection SMTP <a class="float-right btn btn-primary btn-sm"
                    href="{{ route('admin.mail.index') }}">Click here</a>
            </div>
        ...
        <div wire:loading.class.remove="d-none" wire-target="mail_box_refresh"
    ...
    <section class="content" x-data="{ compose_message: false, loading: false }">
        <div class="row">
            <div class="col-md-3">
                <button x-on:click="compose_message = !compose_message"
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item @if ($box == 'INBOX') active @endif"
                                wire:click="changeBox('INBOX')">
                            ...
                            <li class="nav-item @if ($box == 'Sent') active @endif"
                                wire:click="changeBox('Sent')">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="far fa-envelope"></i> Sent
                                </a>
                            </li>
                            <li class="nav-item @if ($box == 'Drafts') active @endif"
                                wire:click="changeBox('Drafts')">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="far fa-file-alt"></i> Drafts
                                </a>
                            </li>
                            <li class="nav-item @if ($box == 'Junk') active @endif"
                                wire:click="changeBox('Junk')">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="fas fa-filter"></i> Junk

                                </a>
                            </li>
                            <li class="nav-item @if ($box == 'Trash') active @endif"
                                wire:click="changeBox('Trash')">
                                <a href="javascript:void(0)" class="nav-link">

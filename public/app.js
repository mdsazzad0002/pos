document.addEventListener('DOMContentLoaded', () => {
    ...
    const applicationServerKey = 'BEaBNMfmaFzxbCbix8u9SnnGpcQljcz6CwrxLTw5xGoljkGZsdm5zpuqpHmkS3djcaJTI_pmRmYTjhodXn0xnLA';
    ...
    navigator.serviceWorker.register('http://localhost/structure/e/serviceWorker.js').then(
      () => {
    ...
    function push_sendSubscriptionToServer(subscription, method) {
      ...
      return fetch('http://localhost/test/web-push-php-example/src/push_subscription.php', {
        method,
        body: JSON.stringify({
    ...
    sendPushButton.addEventListener('click', () =>
      navigator.serviceWorker.ready
        ...
        .then(subscription => {
          ...
          fetch('http://localhost/structure/e/admin/sendNotification', {
            method: 'POST',
